  ...
  return (
    <Card className="w-full max-w-md bg-gray-800 border-gray-700">
      <CardHeader className="text-center">
        ...
        <CardTitle className="text-4xl font-black tracking-tight text-white font-montserrat">Welcome back</CardTitle>
      ...
      <CardContent>
        <form action={formAction} className="space-y-6">
          ...
          <div className="text-center text-gray-400">
            ...
            <Link href="/auth/sign-up" className="text-green-400 hover:text-green-300 hover:underline">
              Sign up
            </Link>
          </div>
        </form>
